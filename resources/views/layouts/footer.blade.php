        ...
        <div class="sm:mx-20 lg:mx-28 flex flex-col lg:flex-row">
            ...
            <div class="w-full">
                <div class="flex flex-row justify-center pt-0 pb-5 lg:pt-20">
                    <a href="https://www.facebook.com/culturalcenterofthephilippines" role="button" class="mx-5">
                        <!-- Facebook -->
                        <svg
                            class="h-7 w-7"
                            fill="white"
                    ...
                    <a href="https://www.youtube.com/user/culturalcenterphils/" role="button" class="mx-5">
                        <!-- Youtube -->
                        <svg 
                            class="w-9 h-9" 
                            viewBox="0 0 24 24" 
                    ...
                    <a href="https://www.instagram.com/culturalcenterph/" role="button" class="mx-5">
                        <!-- Instagram -->
                        <svg
                            class="h-7 w-7"
                            fill="white"
                    ...
                    <a href="https://twitter.com/TheCCPofficial" role="button" class="mx-5">
                        <!-- Twitter -->
                        <svg
                            class="h-7 w-7"
                            fill="white"
