    ...
    <div class="">
        <div class="grid justify-center items-center pt-12">
            <div class="relative z-10">
                ...
                <input type="text" class="text-md md:text-xl form-control text-slate-800 pl-4 pr-20 md:pr-32 lg:pr-40 py-4 w-full rounded-full text-align-start" wire:model.live="query" wire:debounce="1000" placeholder="Search all 10k+ archives..." id="searchEnt">
            </div>
        </div>
